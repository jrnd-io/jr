...
const SyslogLogAvroCRC64Fingerprint = "\xaaIUYr\xa0\xe8\x13"

func NewSyslogLog() SyslogLog {
	r := SyslogLog{}
	return r
}

func DeserializeSyslogLog(r io.Reader) (SyslogLog, error) {
	t := NewSyslogLog()
...
func DeserializeSyslogLogFromSchema(r io.Reader, schema string) (SyslogLog, error) {
	t := NewSyslogLog()
...
func writeSyslogLog(r SyslogLog, w io.Writer) error {
	var err error
...
func (r *SyslogLog) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *SyslogLog) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ SyslogLog) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ SyslogLog) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ SyslogLog) HintSize(int)                     { panic("Unsupported operation") }
func (_ SyslogLog) Finalize()                        {}

func (_ SyslogLog) AvroCRC64Fingerprint() []byte {
	return []byte(SyslogLogAvroCRC64Fingerprint)
}

func (r SyslogLog) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *SyslogLog) UnmarshalJSON(data []byte) error {
