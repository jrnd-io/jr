...
const LocationAvroCRC64Fingerprint = "\xd022#\x84S7\x05"
...
func (r Location) Schema() string {
	return "{\"fields\":[{\"name\":\"latitude\",\"type\":\"double\"},{\"name\":\"longitude\",\"type\":\"double\"}],\"name\":\"fleetmgmt.location\",\"type\":\"record\"}"
}

func (r Location) SchemaName() string {
	return "fleetmgmt.location"
}
