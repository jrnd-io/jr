...
const PizzastoreOrderAvroCRC64Fingerprint = "ux\xc9\xcaq\x9d@\x9a"

func NewPizzastoreOrder() PizzastoreOrder {
	r := PizzastoreOrder{}
...
func DeserializePizzastoreOrder(r io.Reader) (PizzastoreOrder, error) {
	t := NewPizzastoreOrder()
...
func DeserializePizzastoreOrderFromSchema(r io.Reader, schema string) (PizzastoreOrder, error) {
	t := NewPizzastoreOrder()
...
func writePizzastoreOrder(r PizzastoreOrder, w io.Writer) error {
	var err error
...
func (r PizzastoreOrder) Serialize(w io.Writer) error {
	return writePizzastoreOrder(r, w)
}

func (r PizzastoreOrder) Schema() string {
...
func (r PizzastoreOrder) SchemaName() string {
	return "pizzastore.PizzastoreOrder"
}

func (_ PizzastoreOrder) SetBoolean(v bool)    { panic("Unsupported operation") }
func (_ PizzastoreOrder) SetInt(v int32)       { panic("Unsupported operation") }
func (_ PizzastoreOrder) SetLong(v int64)      { panic("Unsupported operation") }
func (_ PizzastoreOrder) SetFloat(v float32)   { panic("Unsupported operation") }
func (_ PizzastoreOrder) SetDouble(v float64)  { panic("Unsupported operation") }
func (_ PizzastoreOrder) SetBytes(v []byte)    { panic("Unsupported operation") }
func (_ PizzastoreOrder) SetString(v string)   { panic("Unsupported operation") }
func (_ PizzastoreOrder) SetUnionElem(v int64) { panic("Unsupported operation") }

func (r *PizzastoreOrder) Get(i int) types.Field {
	switch i {
	case 0:
...
func (r *PizzastoreOrder) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *PizzastoreOrder) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ PizzastoreOrder) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ PizzastoreOrder) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ PizzastoreOrder) HintSize(int)                     { panic("Unsupported operation") }
func (_ PizzastoreOrder) Finalize()                        {}

func (_ PizzastoreOrder) AvroCRC64Fingerprint() []byte {
	return []byte(PizzastoreOrderAvroCRC64Fingerprint)
}

func (r PizzastoreOrder) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *PizzastoreOrder) UnmarshalJSON(data []byte) error {
