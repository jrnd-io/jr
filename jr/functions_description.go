...
var funcDesc = map[string]FunctionDescription{
	...
	"shuffle": {
		Name:        "shuffle",
		Category:    "text utilities",
		Description: "shuffles a string array",
		Parameters:  "[]string",
		Localizable: false,
		Return:      "[]string",
		Example:     "jr run --template '{{shuffle \"state\"}}'",
		Output: "[Connecticut Pennsylvania Nebraska Alaska Montana Maryland Wisconsin Vermont Rhode Island South " +
			"Carolina Washington West Virginia Kansas Delaware Arizona Idaho Texas Illinois Virginia Oklahoma Indiana " +
			"Minnesota Florida Hawaii Massachusetts Alabama Georgia New Mexico Wyoming New Jersey Maine North Carolina " +
			"Kentucky Mississippi Nevada South Dakota New York Ohio California Oregon Utah Iowa New Hampshire Colorado " +
			"Michigan Louisiana Arkansas Tennessee Missouri North Dakota]",
	},
	"shuffle_n": {
		Name:        "shuffle_n",
		Category:    "text utilities",
		Description: "shuffles a string array and return n elements",
		Parameters:  "[]string int",
		Localizable: false,
		Return:      "[]string",
		Example:     "jr run --template '{{shuffle_n \"state\" 5}}'",
