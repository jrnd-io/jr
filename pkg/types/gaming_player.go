...
const GamingPlayerAvroCRC64Fingerprint = "n\x90\x9b\x9c|\x0306"

func NewGamingPlayer() GamingPlayer {
	r := GamingPlayer{}
	return r
}

func DeserializeGamingPlayer(r io.Reader) (GamingPlayer, error) {
	t := NewGamingPlayer()
...
func DeserializeGamingPlayerFromSchema(r io.Reader, schema string) (GamingPlayer, error) {
	t := NewGamingPlayer()
...
func writeGamingPlayer(r GamingPlayer, w io.Writer) error {
	var err error
...
func (r *GamingPlayer) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *GamingPlayer) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ GamingPlayer) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ GamingPlayer) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ GamingPlayer) HintSize(int)                     { panic("Unsupported operation") }
func (_ GamingPlayer) Finalize()                        {}

func (_ GamingPlayer) AvroCRC64Fingerprint() []byte {
	return []byte(GamingPlayerAvroCRC64Fingerprint)
}

func (r GamingPlayer) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *GamingPlayer) UnmarshalJSON(data []byte) error {
