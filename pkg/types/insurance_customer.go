...
const InsuranceCustomerAvroCRC64Fingerprint = "?*G\\\xf7\x1b\xafU"

func NewInsuranceCustomer() InsuranceCustomer {
	r := InsuranceCustomer{}
	return r
}

func DeserializeInsuranceCustomer(r io.Reader) (InsuranceCustomer, error) {
	t := NewInsuranceCustomer()
...
func DeserializeInsuranceCustomerFromSchema(r io.Reader, schema string) (InsuranceCustomer, error) {
	t := NewInsuranceCustomer()
...
func writeInsuranceCustomer(r InsuranceCustomer, w io.Writer) error {
	var err error
...
func (r *InsuranceCustomer) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *InsuranceCustomer) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ InsuranceCustomer) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ InsuranceCustomer) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ InsuranceCustomer) HintSize(int)                     { panic("Unsupported operation") }
func (_ InsuranceCustomer) Finalize()                        {}

func (_ InsuranceCustomer) AvroCRC64Fingerprint() []byte {
	return []byte(InsuranceCustomerAvroCRC64Fingerprint)
}

func (r InsuranceCustomer) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *InsuranceCustomer) UnmarshalJSON(data []byte) error {
