{
  ...
  "message" : "{{random_string_from_source 10 15 "abcdefghijklmnopqrstuvwxyz "}}",
  ...
  "appName" : "{{random_string_from_source 5 8 "ABCDEFGHIJKLMNOPQRSTUVWXYZ"}}",
  ...
  "rawMessage" : "{{random_string_from_source 10 15 "abcdefghijklmnopqrstuvwxyz "}}",
  "processId" : {{random_string_from_source 1 2 "123456789"}}{{random_string_from_source 6 7 "0123456789"}},
  "messageId" : "{{random_string_from_source 1 2 "123456789"}}{{random_string_from_source 2 3 "0123456789"}}",
  ...
  "ts" : {{integer 1609459200000 12609459200000}}
}