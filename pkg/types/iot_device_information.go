...
type IotDeviceInformation struct {
...
const IotDeviceInformationAvroCRC64Fingerprint = "(w\xdc\x10`\x85]\xaf"

func NewIotDeviceInformation() IotDeviceInformation {
	r := IotDeviceInformation{}
	return r
}

func DeserializeIotDeviceInformation(r io.Reader) (IotDeviceInformation, error) {
	t := NewIotDeviceInformation()
...
func DeserializeIotDeviceInformationFromSchema(r io.Reader, schema string) (IotDeviceInformation, error) {
	t := NewIotDeviceInformation()
...
func writeIotDeviceInformation(r IotDeviceInformation, w io.Writer) error {
	var err error
...
func (r *IotDeviceInformation) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *IotDeviceInformation) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ IotDeviceInformation) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ IotDeviceInformation) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ IotDeviceInformation) HintSize(int)                     { panic("Unsupported operation") }
func (_ IotDeviceInformation) Finalize()                        {}

func (_ IotDeviceInformation) AvroCRC64Fingerprint() []byte {
	return []byte(IotDeviceInformationAvroCRC64Fingerprint)
}

func (r IotDeviceInformation) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *IotDeviceInformation) UnmarshalJSON(data []byte) error {
