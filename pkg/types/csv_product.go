...
const CsvProductAvroCRC64Fingerprint = "\xea\xbee\xc5:;\r-"
...
func (r CsvProduct) Schema() string {
	return "{\"fields\":[{\"name\":\"product_id\",\"type\":{\"type\":\"string\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\"}},{\"name\":\"brand\",\"type\":{\"type\":\"string\"}},{\"name\":\"page_url\",\"type\":{\"type\":\"string\"}}],\"name\":\"csv.CsvProduct\",\"type\":\"record\"}"
}

func (r CsvProduct) SchemaName() string {
	return "csv.CsvProduct"
}
