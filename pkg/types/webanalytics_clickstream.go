...
type WebanalyticsClickstream struct {
	Ip string `json:"ip"`
...
const WebanalyticsClickstreamAvroCRC64Fingerprint = "\xda\xddcK\xd0.\xf9z"

func NewWebanalyticsClickstream() WebanalyticsClickstream {
	r := WebanalyticsClickstream{}
	return r
}

func DeserializeWebanalyticsClickstream(r io.Reader) (WebanalyticsClickstream, error) {
	t := NewWebanalyticsClickstream()
...
func DeserializeWebanalyticsClickstreamFromSchema(r io.Reader, schema string) (WebanalyticsClickstream, error) {
	t := NewWebanalyticsClickstream()
...
func writeWebanalyticsClickstream(r WebanalyticsClickstream, w io.Writer) error {
	var err error
...
func (r WebanalyticsClickstream) Serialize(w io.Writer) error {
	return writeWebanalyticsClickstream(r, w)
}

func (r WebanalyticsClickstream) Schema() string {
	return "{\"fields\":[{\"name\":\"ip\",\"type\":{\"arg.properties\":{\"options\":[\"111.152.45.45\",\"111.203.236.146\",\"111.168.57.122\",\"111.249.79.93\",\"111.168.57.122\",\"111.90.225.227\",\"111.173.165.103\",\"111.145.8.144\",\"111.245.174.248\",\"111.245.174.111\",\"222.152.45.45\",\"222.203.236.146\",\"222.168.57.122\",\"222.249.79.93\",\"222.168.57.122\",\"222.90.225.227\",\"222.173.165.103\",\"222.145.8.144\",\"222.245.174.248\",\"222.245.174.222\",\"122.152.45.245\",\"122.203.236.246\",\"122.168.57.222\",\"122.249.79.233\",\"122.168.57.222\",\"122.90.225.227\",\"122.173.165.203\",\"122.145.8.244\",\"122.245.174.248\",\"122.245.174.122\",\"233.152.245.45\",\"233.203.236.146\",\"233.168.257.122\",\"233.249.279.93\",\"233.168.257.122\",\"233.90.225.227\",\"233.173.215.103\",\"233.145.28.144\",\"233.245.174.248\",\"233.245.174.233\"]},\"session\":\"true\",\"type\":\"string\"}},{\"name\":\"userid\",\"type\":{\"arg.properties\":{\"range\":{\"max\":40,\"min\":-1}},\"session-sibling-int-hash\":\"true\",\"type\":\"int\"}},{\"name\":\"remote_user\",\"type\":{\"arg.properties\":{\"options\":[\"-\"]},\"type\":\"string\"}},{\"name\":\"time\",\"type\":{\"arg.properties\":{\"iteration\":{\"start\":1,\"step\":10}},\"format_as_time\":\"dd/MMM/yyyy:HH:mm:ss Z\",\"type\":\"string\"}},{\"name\":\"_logtime\",\"type\":{\"arg.properties\":{\"iteration\":{\"start\":1,\"step\":10}},\"format_as_time\":\"unix_long\",\"type\":\"long\"}},{\"name\":\"request\",\"type\":{\"arg.properties\":{\"options\":[\"GET /index.html HTTP/1.1\",\"GET /site/user_status.html HTTP/1.1\",\"GET /site/login.html HTTP/1.1\",\"GET /site/user_status.html HTTP/1.1\",\"GET /images/track.png HTTP/1.1\",\"GET /images/logo-small.png HTTP/1.1\"]},\"type\":\"string\"}},{\"name\":\"status\",\"type\":{\"arg.properties\":{\"options\":[\"200\",\"302\",\"404\",\"405\",\"406\",\"407\"]},\"type\":\"string\"}},{\"name\":\"bytes\",\"type\":{\"arg.properties\":{\"options\":[\"278\",\"1289\",\"2048\",\"4096\",\"4006\",\"4196\",\"14096\"]},\"type\":\"string\"}},{\"name\":\"referrer\",\"type\":{\"arg.properties\":{\"options\":[\"-\"]},\"type\":\"string\"}},{\"name\":\"agent\",\"type\":{\"arg.properties\":{\"options\":[\"Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)\",\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.115 Safari/537.36\"]},\"type\":\"string\"}}],\"name\":\"webanalytics.WebanalyticsClickstream\",\"type\":\"record\"}"
}

func (r WebanalyticsClickstream) SchemaName() string {
	return "webanalytics.WebanalyticsClickstream"
}

func (_ WebanalyticsClickstream) SetBoolean(v bool)    { panic("Unsupported operation") }
func (_ WebanalyticsClickstream) SetInt(v int32)       { panic("Unsupported operation") }
func (_ WebanalyticsClickstream) SetLong(v int64)      { panic("Unsupported operation") }
func (_ WebanalyticsClickstream) SetFloat(v float32)   { panic("Unsupported operation") }
func (_ WebanalyticsClickstream) SetDouble(v float64)  { panic("Unsupported operation") }
func (_ WebanalyticsClickstream) SetBytes(v []byte)    { panic("Unsupported operation") }
func (_ WebanalyticsClickstream) SetString(v string)   { panic("Unsupported operation") }
func (_ WebanalyticsClickstream) SetUnionElem(v int64) { panic("Unsupported operation") }

func (r *WebanalyticsClickstream) Get(i int) types.Field {
	switch i {
	case 0:
...
func (r *WebanalyticsClickstream) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *WebanalyticsClickstream) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ WebanalyticsClickstream) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ WebanalyticsClickstream) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ WebanalyticsClickstream) HintSize(int)                     { panic("Unsupported operation") }
func (_ WebanalyticsClickstream) Finalize()                        {}

func (_ WebanalyticsClickstream) AvroCRC64Fingerprint() []byte {
	return []byte(WebanalyticsClickstreamAvroCRC64Fingerprint)
}

func (r WebanalyticsClickstream) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *WebanalyticsClickstream) UnmarshalJSON(data []byte) error {
