...
{{ $cardExpire  := (print (regex "^0[1-9]|1[012]$" )  "/" (integer 26 30) )}}{{ add_v_to_list "cardExpire" $cardExpire }}{{ $cardExpire  := (print (regex "^0[1-9]|1[012]$" )  "/" (integer 26 30) )}}{{ add_v_to_list "cardExpire" $cardExpire }}{
     "card_id": {{$cardId}},
