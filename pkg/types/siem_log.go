...
const SiemLogAvroCRC64Fingerprint = "\xcb\xfc\x05v{\xe50t"

func NewSiemLog() SiemLog {
	r := SiemLog{}
	r.Source = NewSource()
...
func DeserializeSiemLog(r io.Reader) (SiemLog, error) {
	t := NewSiemLog()
...
func DeserializeSiemLogFromSchema(r io.Reader, schema string) (SiemLog, error) {
	t := NewSiemLog()
...
func writeSiemLog(r SiemLog, w io.Writer) error {
	var err error
...
func (r *SiemLog) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *SiemLog) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ SiemLog) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ SiemLog) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ SiemLog) HintSize(int)                     { panic("Unsupported operation") }
func (_ SiemLog) Finalize()                        {}

func (_ SiemLog) AvroCRC64Fingerprint() []byte {
	return []byte(SiemLogAvroCRC64Fingerprint)
}

func (r SiemLog) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *SiemLog) UnmarshalJSON(data []byte) error {
